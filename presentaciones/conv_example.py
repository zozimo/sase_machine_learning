...
# load the image
# url = "https://upload.wikimedia.org/wikipedia/commons/thumb/8/88/Commander_Eileen_Collins_-_GPN-2000-001177.jpg/382px-Commander_Eileen_Collins_-_GPN-2000-001177.jpg"
# resp = requests.get(url)
# image_rgb = np.array(Image.open(BytesIO(resp.content)).convert("RGB"))

image_rgb = np.array(Image.open(r'C:\Users\Us\Documents\Python-Deep-Learning-Third-Edition-main\Python-Deep-Learning-Third-Edition-main\Chapter04\arsat-1.jpg').convert("RGB"))
